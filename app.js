...
jQuery(document).ready(function () {
    ...
    function createActionSection(elem_id, section_type, selector) {
        var html = '<div id="section_' + elem_id + '" class="';
        html += (section_type == 'main') ? ' sections"' : 'sub-sections"';
        html += ' ><div id = "builder_' + elem_id + '" class= "builder query-builder actions';
        html += (section_type == 'main') ? ' col-md-6 col-md-offset-3"' : ' col-md-12"';
        html += ' ></div></div>';
    ...
    function queryActionBuilder(elem_id) {
        var html = '<div class="rules-group-body action-container" id="action_container_' + elem_id + '"><div class="rules-list"><div id="action_builder_' + elem_id + '_rule" class="rule-container">' +
